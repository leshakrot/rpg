...
{
    [CreateAssetMenu(fileName = "Gloves Armor", menuName = "RPG/ Gloves Armor/ New Gloves Armor", order = 5)]
    public class GlovesArmorConfig: EquipableItem/*, IModifierProvider*/
    {
        [SerializeField] private GlovesArmor _equippedPrefab;
        ...
        private const string armorName = "Gloves Armor";

        public GlovesArmor Spawn(Transform equipSingle, Transform equipLeft, Transform equipRight)
        {
            DestroyOldArmor(equipSingle, equipLeft, equipRight);

            GlovesArmor armor = null;
