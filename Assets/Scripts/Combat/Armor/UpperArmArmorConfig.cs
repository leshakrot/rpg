...
{
    [CreateAssetMenu(fileName = "UpperArm Armor", menuName = "RPG/ UpperArm Armor/ New UpperArm Armor", order = 2)]
    public class UpperArmArmorConfig: EquipableItem/*, IModifierProvider*/
    {
        [SerializeField] private UpperArmArmor _equippedPrefab;
        ...
        private const string armorName = "UpperArm Armor";

        public UpperArmArmor Spawn(Transform equipSingle, Transform equipLeft, Transform equipRight)
        {
            DestroyOldArmor(equipSingle, equipLeft, equipRight);

            UpperArmArmor armor = null;
