...
namespace RPG.Combat
{
    ...
    public class TrousersArmorConfig : EquipableItem/*, IModifierProvider*/
    {
        ...
        private const string armorName = "Trousers Armor";

        public TrousersArmor Spawn(Transform equipSingle, Transform equipLeft, Transform equipRight)
        {
            DestroyOldArmor(equipSingle, equipLeft, equipRight);

            TrousersArmor armor = null;
