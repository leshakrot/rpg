...
{
    [CreateAssetMenu(fileName = "Helmet Armor", menuName = "RPG/ Helmet Armor/ New Helmet Armor", order = 4)]
    public class HelmetArmorConfig : StatsEquipableItem // EquipableItem/*, IModifierProvider*/
    {
