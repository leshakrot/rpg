...
{
	public class OreSource : HarvestableSource
    {
	    [Header("Настройки руды")]
        [SerializeField] private string harvestAnimationTrigger = "StartMining";
        [SerializeField] private string stopAnimationTrigger = "StopMining";
        ...
        protected override void StartHarvestAnimation()
        {
            if (currentPlayer != null)
            {
                ...
                if (playerAnimator != null && !string.IsNullOrEmpty(harvestAnimationTrigger))
                {
                    ...
                    if (HasAnimatorParameter(playerAnimator, "IsMining"))
                    {
