...
namespace RPG.Harvesting
{
	...
	public class HarvestingTool : InventoryItem
	{
		...
		[SerializeField] private GameObject toolPrefab = null; // Префаб инструмента для отображения в руке
		...
		public GameObject ToolPrefab => toolPrefab; // Новое свойство
		...
		public float GetHarvestSpeedMultiplier(int playerLevel = 1)
		{
			...
			// Небольшой бонус от уровня игроу (каждые 10 уровней +5% скорости)
