...
namespace RPG.Harvesting
{
    ...
    {
        None = 0,      // Без инструмента (только кусты/камни 1 уровня)
        Axe = 1,       // Топор для деревьев
        Pickaxe = 2,   // Кирка для руды
        Sickle = 3,    // Серп для растений/трав
        Skinning = 4   // Нож для снятия шкур
    }
